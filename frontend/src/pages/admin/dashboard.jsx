  ...
  return (
    <div style={{ padding: '2rem', fontFamily: 'Inter, sans-serif' }}>
      <header style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '2.5rem' }}>
        <div>
          <h1 style={{ fontSize: '2.25rem', fontWeight: '800', color: '#111827', margin: 0, letterSpacing: '-0.025em' }}>Dashboard</h1>
          <p style={{ color: '#6b7280', margin: '0.5rem 0 0 0', fontSize: '1rem' }}>Monitor real-time hospital emergencies.</p>
        </div>
        <button style={{ 
